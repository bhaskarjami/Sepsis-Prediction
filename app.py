...
def index():
    if request.method == 'POST':
        ...
        return render_template(
            'index.html',
            result_hidden='', # Show the result section
            ...
            # Pass back the input values to pre-fill the form
            temp=temp, sbp=sbp, resp=resp, wbc=wbc, lactate=lactate, creatinine=creatinine
            # Add other inputs here if you want them to persist
        )
    
    # Initial GET request or after reset
    return render_template('index.html', result_hidden='hidden')
